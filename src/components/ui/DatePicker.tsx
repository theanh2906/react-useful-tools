...
interface DatePickerProps {
  ...
  minDate?: string;
  maxDate?: string;
  dropUp?: boolean; // Force drop up
  centered?: boolean; // Show calendar in center of screen
}
          ...
          <AnimatePresence>
            ...
            <motion.div
              ...
              style={centered ? {
                ...
                position: 'absolute',
                top: dropUp ? 'auto' : `${calendarPosition.top + 8}px`,
                bottom: dropUp ? `${document.documentElement.scrollHeight - calendarPosition.top + 8}px` : 'auto',
                ...
                {calendarDays.map((item, index) => {
                  ...
                  return (
                    <button
                      key={index}
                      type="button"
                      onClick={() => item.isCurrentMonth && !disabled && handleSelectDate(item.day)}
                      ...
                      className={cn(
                        ...
                        item.isCurrentMonth 
                          ...
                          : 'text-slate-600',
                        isSelected && 'bg-gradient-to-br from-primary-500 to-pink-500 text-white font-semibold shadow-lg shadow-primary-500/25',
